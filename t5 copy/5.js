...
for (let i = 0; i< picArray.length; i++){
  let thisImage = picArray[i];

  let imgElement = document.createElement("img");
  imgElement.src = thisImage.image.medium;
  imgElement.alt = thisImage.title;
  let figcaptionElement = document.createElement("figcaption");
  figcaptionElement.innerHTML = thisImage.caption;
  let figureElement = document.createElement("figure");
  figureElement.appendChild(imgElement);
  figureElement.appendChild(figcaptionElement);

  let h2Element = document.createElement("h2");
  h2Element.innerHTML = thisImage.title;

  let pElement = document.createElement("p");
  pElement.innerHTML = thisImage.description;
  ...
  picturesElement.appendChild(articleElement);
}
